        ...
        <>
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <textarea
                                            ...
                                            className="textarea textarea-bordered text-white w-full h-24"
                                            value={about}
                    ...
                    {/* Preview Card */}
                    <div className="w-full max-w-md mx-auto">
                        <h2 className="text-xl font-bold mb-4 text-center">Profile Preview</h2>
                        <UserCard user={{ name, age, gender, about, skills, photourl }} />
                    </div>
                </div>
            </div>
